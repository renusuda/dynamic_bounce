...
abstract class AppLocalizations {
  ...
  /// No description provided for @newBestScoreMessage.
  ///
  /// In en, this message translates to:
  /// **'New Best Score🎉'**
  String get newBestScoreMessage;

  /// No description provided for @topRankingMessage.
  ///
  /// In en, this message translates to:
  /// **'You\'re in the top rankings🏆'**
  String get topRankingMessage;

  /// No description provided for @rankingFetchErrorMessage.
  ///
  /// In en, this message translates to:
  /// **'We couldn\'t fetch ranking data. Please try again later.'**
  String get rankingFetchErrorMessage;

  /// No description provided for @playerNameValidationMessage.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @deleteDialogOk.
  ///
  /// In en, this message translates to:
  /// **'Delete'**
  String get deleteDialogOk;
